...
export default function AnnotationCard({
  ...
  return (
    ...
    >
      ...
      {isRecovered && !isOrphaned && !isPending && (
        <div
          className="flex items-center gap-1 mt-2 text-rda-500 text-xs font-medium"
          title="This annotation was recovered after the page finished loading"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
